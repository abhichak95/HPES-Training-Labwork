...
public class Admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("&nbsp;&nbsp;<input type='radio' name='option' value='delete'> Delete Entry");
            out.println("&nbsp;&nbsp;<input type='radio' name='option' value='update'> Update Entry");
            ...
            System.out.println("NullPointerException1: " + e.getMessage());
            response.sendRedirect(homepage);
        }
        finally {
            out.println("</body>");
