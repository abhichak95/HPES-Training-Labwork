...
public class RegisterUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String logoutPage = (String) context.getInitParameter("logout");
        try {
            ...
            out.println("<h1>User Registration Status: Success</h1><br>");
            
            HttpSession session = request.getSession();
            String usertypeString = (String)session.getAttribute("userType");
            if (usertypeString.equalsIgnoreCase("admin")) {
                request.setAttribute("UpdationMsg", "Insertion Successful!");
                out.println("<div style='text-align: right;'><a href='" + logoutPage + "'><h3>Log Out</h3></a></div>");
                request.getRequestDispatcher(adminPage).forward(request, response);
            }
            else out.println("<br><br><a href='" + request.getContextPath() + "/" + homepage + "'>Click here</a> to return to welcome page...");
            con.close();
        }
            ...
            out.println("<br><br><a href='" + request.getContextPath() + "/" + homepage + "'>Click here</a> to return to welcome page...");
        }
