...
public class UpdatePage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String homepage = (String) cnf.getInitParameter("homepage");
        ...
        try {
            ...
            out.println("<center>");
            out.println("<h1>User Updation</h1><br><br>");
            ...
            out.println("<label>User ID</label>: <input type='text' name='id' value='" + id + "' disabled><br><br>");
